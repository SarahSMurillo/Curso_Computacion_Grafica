// Previo 8        Murillo Rodriguez Sarah Sofia
// 22-03-2026     422130448
// Std. Includes
#include <string>
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.diffuse"), 0.5f, 0.2f, 0.8f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.specular"), 0.4f, 0.6f, 0.3f);
        ...
        //Modelo perro1
        glm::mat4 modelPerro1(1);
        modelPerro1 = glm::mat4(1);
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, lightPos + glm::vec3(movelightPos));
