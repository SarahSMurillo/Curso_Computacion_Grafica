//Practica Adicional       Murillo Rodriguez Sarah Sofia
//02-05-2026       422130448
#include <iostream>
#include <cmath>
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion maquina de estados, Sarah Murillo", nullptr, nullptr);
	...
	Shader skyboxshader("Shader/SkyBox.vs", "Shader/SkyBox.frag"); //nuevo
	...
	glGenBuffers(1, &VBO);
	glGenBuffers(1, &EBO); //nuevo

	glBindVertexArray(VAO);
	glBindBuffer(GL_ARRAY_BUFFER, VBO);
	glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW);

	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, EBO); //nuevo / cambio
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(indices), indices, GL_STATIC_DRAW); //nuevo / cambio
	...
	glBindVertexArray(skyboxVAO); //CAMBIO
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Draw SkyBox nuevo envio al shader
