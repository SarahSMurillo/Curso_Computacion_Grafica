//Previo 9      Murillo Rodriguez Sarah Sofia
//30-030-26     422130448
...
int main()
{
	...
	Model Dog((char*)"Models/WIndow01.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "transparency"), 1); //se pone en 1 si es transparente
